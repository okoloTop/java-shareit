...
class BookingServiceImplTest {
    ...
    @Test
    void createBookingDateStartNullTest() {
        when(userRepository.findById(anyLong()))
                .thenReturn(Optional.of(user));
        when(itemRepository.findById(anyLong()))
                .thenReturn(Optional.of(item));
        ...
        Throwable throwable = Assertions.catchException(() -> bookingService.createBooking(2L, bookingNewDto));

        Assertions.assertThat(throwable)
                .isInstanceOf(AccessException.class)
                .hasMessage("Укажите корректные даты бронирования вещи");
    }

    @Test
    void createBookingDateEndNullTest() {
        when(userRepository.findById(anyLong()))
                .thenReturn(Optional.of(user));
        when(itemRepository.findById(anyLong()))
                .thenReturn(Optional.of(item));
    ...
    @Test
    void createBookingDateStartEqualEndTest() {
        when(userRepository.findById(anyLong()))
                .thenReturn(Optional.of(user));
        when(itemRepository.findById(anyLong()))
                .thenReturn(Optional.of(item));
        ...
        Assertions.assertThat(throwable)
                .isInstanceOf(AccessException.class)
                .hasMessage("Дата начала бронирования и окончания не должна совпадать");
    }

    @Test
    void createBookingDateStartBeforeNowTest() {
        when(userRepository.findById(anyLong()))
                .thenReturn(Optional.of(user));
        when(itemRepository.findById(anyLong()))
                .thenReturn(Optional.of(item));
        ...
        Assertions.assertThat(throwable)
                .isInstanceOf(AccessException.class)
                .hasMessage("Дата начала бронирования должна быть в будущем");
    }
    ...
    @Test
    void createBookingDateEndBeforeNowTest() {
        when(userRepository.findById(anyLong()))
                .thenReturn(Optional.of(user));
        when(itemRepository.findById(anyLong()))
                .thenReturn(Optional.of(item));
        ...
        Assertions.assertThat(throwable)
                .isInstanceOf(AccessException.class)
                .hasMessage("Дата окончания бронирования должна быть в будущем");
    }

    @Test
    void createBookingDateStartAfterEndTest() {
        ...
        Assertions.assertThat(throwable)
                .isInstanceOf(AccessException.class)
                .hasMessage("Некорректные даты бронирования");
    }
}
